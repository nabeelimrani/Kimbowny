            ...
            <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                <div class="col-first">
                    ...
                    <nav class="d-flex align-items-center">
                        ...
                        <a href="{{ route('singleblog') }}">Blog</a>
                    </nav>
                </div>
            </div>
        </div>
                    ...
                    <div class="single-post row">
                        <div class="col-lg-12">
                            <div class="feature-img">
                                <img class="img-fluid" src="{{ asset('frontEnd/img/blog/feature-img1.jpg') }}"
                                    alt="">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <img class="img-fluid" src="{{ asset('frontEnd/img/blog/post-img1.jpg') }}"
                                        alt="">
                                </div>
                                <div class="col-6">
                                    <img class="img-fluid" src="{{ asset('frontEnd/img/blog/post-img2.jpg') }}"
                                        alt="">
                                </div>
                    ...
                    <div class="navigation-area">
                        <div class="row">
                            ...
                            <div
                                ...
                                <div class="thumb">
                                    <a href="#"><img class="img-fluid" src="{{ asset('frontEnd/img/blog/next.jpg') }}"
                                            alt=""></a>
                                </div>
                            </div>
                        </div>
