...
@section('main-section')
    @push('title')
        <title>Add Flavor - Kimbowny</title>
    @endpush
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                      <h1><i class="fas fa-utensils"></i>&nbsp;Add Flavor</h1>
                    ...
                    <div class="col-sm-6">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.flavor.show') }}" class="btn btn-submit">View</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-8 offset-2">
                        <div class="card">
                            <div class="card-header"
                                ...
                                <h3 class="card-title" style="font-size: 0.8em;">Add Flavor</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="flavorname"
                                                ...
                                                placeholder="Flavor Name..." value="{{ old('flavorname') }}">
                                        </div>
                                        @error('flavorname')
