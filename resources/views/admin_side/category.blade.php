...
@section('main-section')
    @push('title')
        <title>Add Category - Kimbowny</title>
    @endpush
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.category.show') }}" class="btn btn-submit">View</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-8 offset-2">
                        <div class="card">
                            <div class="card-header"
                                ...
                                <h3 class="card-title" style="font-size: 0.8em;">Add Category</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="categoryname"
                                                ...
                                                placeholder="Category Title..." value="{{ old('categoryname') }}">
                                        </div>
                                        @error('categoryname')
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="image"
                                                    style="color: #999999e8;">Choose Category Image...</label>
                                            </div>
                                        </div>
                                        @error('categoryimage')
                                            <span class="text-danger">{{ $message }}</span>
