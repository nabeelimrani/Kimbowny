...
@section('main-section')
    @push('title')
        <title>View Weight - Kimbowny</title>
    @endpush
    <style>
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="fas fa-weight-hanging"></i>&nbsp;View Weight</h1>
                    </div>
                    <div class="col-sm-6">
                        <div class="d-flex justify-content-between align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                                <li class="breadcrumb-item active">View Weight
                                </li>
                            </ol>
                            <a href="{{ route('admin.weight.index') }}" class="btn btn-info">Add Weight</a>
                        </div>
                    </div>
                </div>
        </section>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header sticky" style="background-color: #007bff; color: #fff;">
                                <h3 class="card-title"
                                    style="font-size: 1.5em; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.8);">Weight Table
                                </h3>
                            ...
                            <div class="card-body table-responsive p-2" style="background-color: #f8f9fa;">
                                <table id="example" class="table table-hover table-striped text-nowrap">
                                    ...
                                    <tbody>
                                        @if (isset($weight))
                                            @foreach ($weight as $index => $weightdata)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            <button class="btn btn-sm btn-outline-primary"
                                                                data-toggle="modal"
                                                                data-target="#editModal{{ $weightdata->id }}">
                                                                <i class="fa fa-edit" style="font-size: 1.2em;"></i>
                                                            </button>&nbsp;&nbsp;
                                                            <button class="btn btn-sm btn-outline-danger"
                                                                data-toggle="modal"
                                                                data-target="#deleteModal{{ $weightdata->id }}">
                                                ...
                                                <!-- Delete Modal -->
                                                <div class="modal fade" id="deleteModal{{ $weightdata->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form
                                                                    action="{{ route('admin.weight.del', ['id' => $weightdata->id]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <button type="submit"
                                                ...
                                                <!-- Edit Area Modal -->
                                                <div class="modal fade" id="editModal{{ $weightdata->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form
                                                                    action="{{ route('admin.weight.edit', ['id' => $weightdata->id]) }}"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" name="weightname"
                                                                                required
                                                                                class="form-control @error('weightname') is-invalid @enderror"
